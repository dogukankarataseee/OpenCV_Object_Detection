...
# orb tanımlayıcı
# köşe-kenar gibi nesneye ait "Anahtar" özellikler
orb = cv2.ORB_create()

# anahtar nokta tespiti
kp1, des1 = orb.detectAndCompute(cho, None)  # maskeleme = "none"
kp2, des2 = orb.detectAndCompute(chos, None) # maskeleme = "none"

# bf matcher
bf = cv2.BFMatcher(cv2.NORM_HAMMING) # method = NORM_HAMMING
# noktaları eşleştir
